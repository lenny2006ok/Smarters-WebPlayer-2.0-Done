...
if (isset($_GET["c"]) && $_GET["c"] != "") {
    ...
    $variablesArray = ["activepage" => "series", "pagetitle" => "Series", "classsname" => "main-bg", "section" => "series", "logovalue" => $LogoIs, "sitetitle" => $sitetitle, "getBlockedStreamsIts" => $getBlockedStreamsIts, "getBlockedCategoriesIts" => $getBlockedCategoriesIts, "Getblockedsection" => $Getblockedsection, "funconn" => $funconn, "categoryid" => $categoryid, "BannerData" => $BannerData, "categories" => $FinalCategoriesArray, "license" => $ValidLicense];
    $dispatcher->dispatch("header", $conn, $variablesArray);
    $dispatcher->dispatch("navigation", $conn, $variablesArray);
    $dispatcher->dispatch("serieslist", $conn, $variablesArray);
