...
if (isset($_GET["c"]) && $_GET["c"] != "") {
    ...
    $variablesArray = ["activepage" => "movies", "pagetitle" => "Movies", "classsname" => "main-bg", "section" => "movies", "logovalue" => $LogoIs, "sitetitle" => $sitetitle, "funconn" => $funconn, "categoryid" => $categoryid, "getBlockedStreamsIts" => $getBlockedStreamsIts, "getBlockedCategoriesIts" => $getBlockedCategoriesIts, "Getblockedsection" => $Getblockedsection, "categories" => $FinalCategoriesArray, "BannerData" => $BannerData, "license" => $ValidLicense];
    $dispatcher->dispatch("header", $conn, $variablesArray);
    $dispatcher->dispatch("navigation", $conn, $variablesArray);
    $dispatcher->dispatch("movieslist", $conn, $variablesArray);
