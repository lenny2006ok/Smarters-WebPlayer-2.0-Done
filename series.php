...
$GetFavforCategories = $funconn->webtvpanel_getFavforCategories("series", $conn);
...
$variablesArray = ["activepage" => "categories", "pagetitle" => "Series Categories", "classsname" => "dash-bg", "section" => "series", "logovalue" => $LogoIs, "sitetitle" => $sitetitle, "Getblockedsection" => $Getblockedsection, "categories" => $FinalCategoriesArray, "license" => $ValidLicense];
$dispatcher->dispatch("header", $conn, $variablesArray);
$dispatcher->dispatch("navigation", $conn, $variablesArray);
$dispatcher->dispatch("series", $conn, $variablesArray);
