...
$variablesArray = ["activepage" => "settings", "pagetitle" => "Webplayer Settings", "classsname" => "main-bg", "section" => "settings", "logovalue" => $LogoIs, "sitetitle" => $sitetitle, "Getblockedsection" => $Getblockedsection, "funconn" => $funconn, "categories" => $FinalCategoriesArray, "license" => $ValidLicense];
$dispatcher->dispatch("header", $conn, $variablesArray);
$dispatcher->dispatch("navigation", $conn, $variablesArray);
$dispatcher->dispatch("settings", $conn, $variablesArray);
