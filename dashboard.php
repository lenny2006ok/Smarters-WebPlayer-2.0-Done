...
$variablesArray = ["activepage" => "dashboard", "pagetitle" => "Dashboard", "classsname" => "dash-bg", "logovalue" => $LogoIs, "sitetitle" => $sitetitle, "Getblockedsection" => $Getblockedsection, "license" => $ValidLicense];
$dispatcher->dispatch("header", $conn, $variablesArray);
$dispatcher->dispatch("dashboard", $conn, $variablesArray);
