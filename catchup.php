...
$variablesArray = ["activepage" => "categories", "pagetitle" => "Catch Categories", "classsname" => "dash-bg", "section" => "catchup", "logovalue" => $LogoIs, "sitetitle" => $sitetitle, "Getblockedsection" => $Getblockedsection, "categoryid" => $categoryid, "categories" => $FinalCategoriesArray, "license" => $ValidLicense];
$dispatcher->dispatch("header", $conn, $variablesArray);
$dispatcher->dispatch("navigation", $conn, $variablesArray);
$dispatcher->dispatch("catchup", $conn, $variablesArray);
